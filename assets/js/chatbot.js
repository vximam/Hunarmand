        ...
        setTimeout(() => {
            ...
            if (activeMode === "guest") {
                if (cleanInput.includes("what is") || cleanInput.includes("hunarmand")) {
                    ...
                    outputResponse = "Ready to start? Click below to build your user profile node:<br><a href='signup.html' class='chat-redirect-btn'>Register New Account</a>";
                } else {
            ...
            // --- CRITERIA 2: USER MODE WORKER MATRICULATION ---
                ...
                if (expertCategory) {
                    outputResponse += `<br><br>Click below to browse verified profiles:<br><a href='hiring.html?role=${expertCategory.toLowerCase()}' class='chat-redirect-btn'>Hire Verified ${expertCategory}</a>`;
                } else {
